...
export const Search = () => {
    ...
    return (
        <div className="relative hidden md:block  lg:w-[320px] xl:w-[492px]">
            ...
            <input onChange={(e) => handleSearch(e.target.value.trim())} placeholder="Search something here" className="w-full border border-[#c3d4e966]  rounded-[70px] py-[11px] pl-12 lg:pl-16 pr-11 placeholder:text-secondary text-sm font-medium leading-[21px] tracking-tighter-[-0.28px]" />
