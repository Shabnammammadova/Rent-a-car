...
//                             />
//                             <label htmlFor="avatar-upload" className="absolute bottom-0 right-16 bg-gray-400 text-white rounded-full cursor-pointer w-[30px] h-[30px]">
...
const ProfilePage = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Here, you would dispatch an action to update the user profile in the store
        // dispatch(updateUserProfile({ avatar: avatarFile, name, email }));
    };
            ...
            <div className="bg-white shadow-md rounded-lg w-full max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 bg-blue-50 rounded-lg">
                    <div className="text-center">
                        ...
                        <h1 className="text-3xl font-bold pt-8 lg:pt-0">{name || "Your name"}</h1>
                    </div>
                    <div className="mt-6 space-y-2">
                        <div>
                            <p className="text-sm font-bold">Github</p>
